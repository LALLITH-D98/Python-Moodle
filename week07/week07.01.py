...
the number itself. Proper divisors of the number are those that are strictly lesser than
the number.
Input Format:
...
Yes
Explanation
The proper divisors of 12 are: 1, 2, 3, 4, 6, whose sum is 1 + 2 + 3 + 4 + 6 = 16. Since sum
of proper divisors is greater than the given number, 12 is an abundant number.
Example input:
13
Output:
No
